...
struct MeshfreeDebugOptions
{
    ...
    std::filesystem::path cloudPath =
        cressim::neo::examples::helpers::assetPath("models/physics/data/gallbladder_particles.bin");
    std::filesystem::path surfacePath =
        cressim::neo::examples::helpers::assetPath("models/physics/data/Gallbladder.obj");

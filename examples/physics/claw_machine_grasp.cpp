...
constexpr float kSliderGripCloseTargetScale = 0.8f;
constexpr float kHingeGripCloseTargetScale = 0.8f;
constexpr float kFingerJointConstraintCompliance = 1.0e-6f;
constexpr float kFingerJointDriveCompliance = 1.8f;
constexpr float kGantrySliderDriveCompliance = 1.8f;
constexpr float kGantrySliderDriveDamping = 3.5f;
...
constexpr float kFingerSliderDriveDamping = 3.5f;

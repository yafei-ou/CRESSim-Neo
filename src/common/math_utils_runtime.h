...
inline Diligent::QuaternionF quaternionFromEulerDegrees(float xDegrees, float yDegrees, float zDegrees)
{
  ...
  return Diligent::QuaternionF{sinZ * cosX * cosY - cosZ * sinX * sinY,

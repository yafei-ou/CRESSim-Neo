                                            ...
                                            const ProgramKey &key, ProgramResources &outResources)
{
    ...
    constexpr Diligent::ShaderResourceVariableDesc kVars[] = {
        ...
        {Diligent::SHADER_TYPE_PIXEL, "g_MetallicRoughnessTexture",
         Diligent::SHADER_RESOURCE_VARIABLE_TYPE_DYNAMIC},
        {Diligent::SHADER_TYPE_PIXEL, "g_EmissiveTexture",
         Diligent::SHADER_RESOURCE_VARIABLE_TYPE_DYNAMIC},
        {Diligent::SHADER_TYPE_PIXEL, "g_AoTexture",
         Diligent::SHADER_RESOURCE_VARIABLE_TYPE_DYNAMIC},
        {Diligent::SHADER_TYPE_PIXEL, "g_IrradianceMap",
         Diligent::SHADER_RESOURCE_VARIABLE_TYPE_DYNAMIC},
        {Diligent::SHADER_TYPE_PIXEL, "g_PrefilteredSpecularMap",
         Diligent::SHADER_RESOURCE_VARIABLE_TYPE_DYNAMIC},
        {Diligent::SHADER_TYPE_PIXEL, "g_BrdfLut", Diligent::SHADER_RESOURCE_VARIABLE_TYPE_DYNAMIC},

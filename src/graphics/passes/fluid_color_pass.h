#ifndef CRESSIM_NEO_GRAPHICS_PASSES_FLUID_COLOR_PASS_H
#define CRESSIM_NEO_GRAPHICS_PASSES_FLUID_COLOR_PASS_H
...
{
public:
    explicit FluidColorPass(gpu::GpuDevice &device);

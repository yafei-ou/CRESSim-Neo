#ifndef CRESSIM_NEO_GRAPHICS_PASSES_CAMERA_SEGMENTATION_PASS_H
...
{
public:
    CameraSegmentationPass(gpu::GpuDevice &device, RenderResourceManager &resourceManager);
...
private:
    ...
    struct PipelineKey
    {
        ...
        {
            return programFamily == rhs.programFamily && colorFormat == rhs.colorFormat &&
...
#endif // CRESSIM_NEO_GRAPHICS_PASSES_CAMERA_SEGMENTATION_PASS_H

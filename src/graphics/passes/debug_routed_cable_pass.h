#ifndef CRESSIM_NEO_GRAPHICS_DEBUG_ROUTED_CABLE_PASS_H
#define CRESSIM_NEO_GRAPHICS_DEBUG_ROUTED_CABLE_PASS_H
...
{
public:
    explicit DebugRoutedCablePass(gpu::GpuDevice &device);

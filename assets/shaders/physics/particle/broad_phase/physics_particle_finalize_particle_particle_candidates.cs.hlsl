...
void main(uint3 dispatchThreadID : SV_DispatchThreadID)
{
    ...
    meta.requiredParticleParticleCandidateCount = requiredCount;
    meta.particleParticleCandidateCount = min(requiredCount, particleCandidatePairCapacity);
    meta.particleParticleCandidateOverflow = requiredCount > particleCandidatePairCapacity ? 1u : 0u;

...
void main(uint3 dispatchThreadID : SV_DispatchThreadID)
{
    ...
    meta.requiredParticleRigidCandidateCount = requiredCount;
    meta.particleRigidCandidateCount = min(requiredCount, particleCandidatePairCapacity);
    meta.particleRigidCandidateOverflow = requiredCount > particleCandidatePairCapacity ? 1u : 0u;

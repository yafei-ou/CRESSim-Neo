...
void main(uint3 dispatchThreadID : SV_DispatchThreadID)
{
    ...
    meta.requiredSoftRigidCandidateCount = requiredCount;
    meta.softRigidCandidateCount = min(requiredCount, softCandidatePairCapacity);
    meta.softRigidCandidateOverflow = requiredCount > softCandidatePairCapacity ? 1u : 0u;

...
try:
    ...
    raise RuntimeError(
        "cressim_neo_envs.tissue_retract_env requires PyTorch to be installed."
    ) from exc
...
class TissueRetractTorchVectorEnv(TorchStagedVectorEnvBase):
    ACTION_DIM = 7
    OBSERVATION_DIM = 29
...
__all__ = ["TissueRetractTorchVectorEnv"]

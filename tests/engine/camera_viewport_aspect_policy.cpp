...
int main()
{
    ...
    {
        CRESSIM_LOG_ERROR( "Fullscreen viewport aspect mismatch.\n");
        return 1;
    }
    ...
    {
        CRESSIM_LOG_ERROR( "Half-width viewport aspect mismatch.\n");
        return 1;
    }
    ...
    {
        CRESSIM_LOG_ERROR( "2x2 tiled viewport aspect mismatch.\n");
        return 1;
    }
    ...
    {
        CRESSIM_LOG_ERROR( "Non-square tiled viewport aspect mismatch.\n");
        return 1;
    }

    CRESSIM_LOG_INFO( "Camera viewport aspect policy checks passed.\n");
    return 0;
}

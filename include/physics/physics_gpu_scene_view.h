...
/// @brief Non-owning GPU buffer views and descriptor structures published by the physics solver for
...
struct PhysicsGpuRigidSceneView
{
    ...
    Diligent::IBuffer *statePositionsBuffer =
        nullptr; ///< GPU buffer of rigid-body center-of-mass positions and inverse masses.
    Diligent::IBuffer *stateOrientationsBuffer =
        nullptr; ///< GPU buffer of rigid-body orientation quaternions.
    Diligent::IBuffer *stateLinearVelocitiesBuffer =
        nullptr; ///< GPU buffer of rigid-body linear velocity vectors.
    Diligent::IBuffer *stateAngularVelocitiesBuffer =
        nullptr; ///< GPU buffer of rigid-body angular velocity vectors.
    Diligent::IBuffer *inverseInertiaLocalBuffer =
        nullptr; ///< GPU buffer of body-local diagonal inverse inertia tensors.
    ...
    Diligent::IBuffer *proxyParticleContactMaterialsBuffer =
        nullptr; ///< GPU buffer of proxy contact material parameters.
    Diligent::IBuffer *kinematicTargetPositionsBuffer =
        nullptr; ///< GPU buffer of kinematic target positions.
    Diligent::IBuffer *kinematicTargetOrientationsBuffer =
        nullptr; ///< GPU buffer of kinematic target orientations.
    Diligent::IBuffer *kinematicTargetFlagsBuffer =
        nullptr; ///< GPU buffer of kinematic drive target active flags.
    Diligent::IBuffer *colliderOwnerBodyIndicesBuffer =
        nullptr; ///< GPU buffer mapping colliders to owning rigid-body indices.
    Diligent::IBuffer *colliderBroadPhaseBuffer =
        nullptr; ///< GPU buffer of collider axis-aligned bounding boxes (AABBs).
    Diligent::IBuffer *colliderGeometryBuffer =
        nullptr; ///< GPU buffer of collider geometric dimensions (radius, half-extents).
    Diligent::IBuffer *colliderMaterialsBuffer =
        nullptr; ///< GPU buffer of collider friction and restitution parameters.
    Diligent::IBuffer *colliderShapeTypesBuffer =
        nullptr; ///< GPU buffer of ColliderShapeType values.
    Diligent::IBuffer *colliderEnabledFlagsBuffer =
        nullptr; ///< GPU buffer of collider enabled bitflags.
    Diligent::IBuffer *bodyColliderOffsetsBuffer =
        nullptr; ///< GPU buffer of start offsets into the collider index list per body.
    Diligent::IBuffer *bodyColliderCountsBuffer =
        nullptr; ///< GPU buffer of collider counts per rigid body.
    ...
    Diligent::IBuffer *strandRigidAttachmentsBuffer =
        nullptr; ///< GPU buffer of StrandRigidAttachmentConstraint descriptors.
    Diligent::IBuffer *rigidDistanceConstraintsBuffer =
        nullptr; ///< GPU buffer of RigidDistanceConstraint descriptors.
    Diligent::IBuffer *routedCableDescriptorsBuffer =
        nullptr; ///< GPU buffer of RoutedCableConstraint descriptors.
    Diligent::IBuffer *routedCableRoutePointsBuffer =
        nullptr; ///< GPU buffer of RoutedCableRoutePoint descriptors.
    Diligent::IBuffer *routedCableDebugSegmentsBuffer =
        nullptr;                 ///< GPU buffer for routed cable debug line visualizer segments.
    std::uint32_t bodyCount = 0; ///< Total active rigid bodies in the scene.
    std::uint32_t rigidParticleAttachmentCount =
        0; ///< Number of rigid-particle attachment constraints.
    std::uint32_t strandRigidAttachmentCount =
        0; ///< Number of strand-rigid attachment constraints.
    std::uint32_t rigidDistanceConstraintCount =
        0; ///< Number of rigid-to-rigid distance constraints.
    ...
    std::uint32_t routedCableDebugSegmentCount =
        0;                               ///< Number of debug line segments for cable rendering.
    ...
    std::uint64_t constraintBindingGeneration =
        0; ///< Revision counter for constraint buffer allocations.
};
...
struct PhysicsGpuJointSceneView
{
    ...
    Diligent::IBuffer *sphericalJointsBuffer =
        nullptr; ///< GPU buffer of SphericalJointState descriptors.
    ...
    Diligent::IBuffer *hingeJointRuntimeStatesBuffer =
        nullptr; ///< GPU buffer of dynamic runtime hinge joint state.
    Diligent::IBuffer *sliderJointsBuffer =
        nullptr; ///< GPU buffer of SliderJointState descriptors.
    Diligent::IBuffer *sliderJointRuntimeStatesBuffer =
        nullptr;                            ///< GPU buffer of dynamic runtime slider joint state.
...
/// @brief GPU buffer bindings for unified particle systems (soft bodies, strands, fluids, and proxy
/// particles).
struct PhysicsGpuParticleBufferView
{
    Diligent::IBuffer *positionsInvMassBuffer =
        nullptr; ///< GPU buffer of float4 particle positions (xyz) and inverse mass (w).
    Diligent::IBuffer *previousPositionsBuffer =
        nullptr; ///< GPU buffer of particle positions from previous substep.
    Diligent::IBuffer *velocitiesBuffer =
        nullptr;                              ///< GPU buffer of float4 particle velocity vectors.
    Diligent::IBuffer *radiiBuffer = nullptr; ///< GPU buffer of particle collision radii.
    Diligent::IBuffer *environmentIndicesBuffer =
        nullptr;                                      ///< GPU buffer of environment assignments.
    ...
    Diligent::IBuffer *ownerIndicesBuffer =
        nullptr; ///< GPU buffer of owning body/strand/fluid index.
    Diligent::IBuffer *strandIdsBuffer =
        nullptr; ///< GPU buffer of strand IDs for strand particles.
    Diligent::IBuffer *strandRolesBuffer =
        nullptr; ///< GPU buffer of ParticleStrandRole suturing values.
    Diligent::IBuffer *suturingNeighborLinksBuffer =
        nullptr; ///< GPU buffer of suturing neighbor topological links.
    Diligent::IBuffer *owningSoftBodyIndicesBuffer =
        nullptr; ///< GPU buffer mapping particles to owning soft-body index.
    Diligent::IBuffer *particleMaterialIndicesBuffer =
        nullptr; ///< GPU buffer of contact material indices.
    Diligent::IBuffer *fluidMaterialIndicesBuffer =
        nullptr; ///< GPU buffer of fluid material indices.
    Diligent::IBuffer *fluidVisualsBuffer =
        nullptr; ///< GPU buffer of fluid particle render colors.
    Diligent::IBuffer *particleContactMaterialsBuffer =
        nullptr; ///< GPU buffer of contact material parameters.
    Diligent::IBuffer *fluidMaterialsBuffer =
        nullptr; ///< GPU buffer of FluidMaterialGpu parameters.
    Diligent::IBuffer *phasesBuffer =
        nullptr; ///< GPU buffer of packed particle collision phase bitfields.
    ...
    Diligent::IBuffer *adjacencyOffsetsBuffer =
        nullptr; ///< GPU buffer of neighbor adjacency list start offsets.
    Diligent::IBuffer *adjacencyCountsBuffer =
        nullptr; ///< GPU buffer of neighbor adjacency counts.
    Diligent::IBuffer *adjacencyIndicesBuffer =
        nullptr; ///< GPU buffer of flattened neighbor particle indices.
    Diligent::IBuffer *fluidSurfaceNormalConstraintsBuffer =
        nullptr; ///< GPU buffer of fluid surface normal constraints.
    Diligent::IBuffer *fluidAnisotropy1Buffer =
        nullptr; ///< GPU buffer of fluid surface anisotropy tensor column 1.
    Diligent::IBuffer *fluidAnisotropy2Buffer =
        nullptr; ///< GPU buffer of fluid surface anisotropy tensor column 2.
    Diligent::IBuffer *fluidAnisotropy3Buffer =
        nullptr; ///< GPU buffer of fluid surface anisotropy tensor column 3.
...
struct PhysicsGpuSoftSceneView
{
    ...
    Diligent::IBuffer *strandSegmentsBuffer =
        nullptr; ///< GPU buffer of StrandSegmentConstraint descriptors.
    Diligent::IBuffer *strandJointsBuffer =
        nullptr; ///< GPU buffer of StrandJointConstraint descriptors.
    ...
    Diligent::IBuffer *segmentIncidentStrandJointsBuffer =
        nullptr; ///< GPU buffer of incident strand joint indices.
    Diligent::IBuffer *suturingPairsBuffer =
        nullptr; ///< GPU buffer of StrandSoftSuturingPair descriptors.
    Diligent::IBuffer *suturingParticleRefsBuffer =
        nullptr; ///< GPU buffer of suturing particle references.
    Diligent::IBuffer *suturingInsertionStatesBuffer =
        nullptr; ///< GPU buffer of GpuSuturingInsertionState tracking.
    Diligent::IBuffer *suturingPathHeadersBuffer =
        nullptr; ///< GPU buffer of SuturingPathHeader descriptors.
    Diligent::IBuffer *suturingPathNodesBuffer =
        nullptr; ///< GPU buffer of SuturingPathNode interpolation points.
    Diligent::IBuffer *renderPositionsBuffer =
        nullptr; ///< GPU buffer of interpolated surface render vertex positions.
...
struct PhysicsGpuCurveSceneView
{
    Diligent::IBuffer *descriptorsBuffer =
        nullptr; ///< GPU buffer of CurveRenderDescriptorHost descriptors.
    Diligent::IBuffer *particleIndicesBuffer =
        nullptr; ///< GPU buffer of particle indices forming each curve.
    Diligent::IBuffer *positionsBuffer =
        nullptr; ///< GPU buffer of generated curve vertex positions.
    Diligent::IBuffer *normalsBuffer =
        nullptr; ///< GPU buffer of generated curve vertex normal vectors.
...
{
    PhysicsGpuRigidSceneView
        rigid{}; ///< GPU view for rigid bodies, colliders, and rigid constraints.

...
struct CameraData
{
    ...
    {
        ColorDepth = 0u, ///< Standard RGB color buffer and linear depth; supports ManagedPrimary.
        Depth      = 1u, ///< High-precision depth buffer; requires an ExplicitSurface depth target.
        SegmentationDepth = 2u, ///< Integer class mask and linear depth; requires an
                                ///< ExplicitSurface target with color+depth and R32_UINT color.
    };
    ...
    gpu::RenderOutputBinding output{}; ///< Output destination. ManagedPrimary accepts ColorDepth
                                       ///< only; other products require ExplicitSurface.
    ...
    gpu::GpuRenderViewport viewport{}; ///< Normalized subregion viewport; currently honored only
                                       ///< for non-layered ExplicitSurface targets.
